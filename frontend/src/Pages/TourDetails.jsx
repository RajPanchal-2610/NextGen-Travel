            ...
            <Col lg="8">
              <div className="tour__content">
                ...
                <div>
                  ...
                  >
                    <li>Transfers & Sightseeing by AC Vehicles suitable to the group size.</li>
                    <li>Accommodation in the mentioned or Similar hotels. </li>
                    <li>Daily Breakfast, Lunch & Dinner Included as per the Inclusions.</li>
                  </ul>
                  <br />
